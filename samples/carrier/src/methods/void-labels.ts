...
const mapRequest = (request: requests.VoidLabelsRequest): any => { throw new NotImplementedError(); };
const callApi = async (request: any): Promise<any> => { throw new NotImplementedError(); };
const mapResponse = (response: any): responses.VoidLabelsResponse => { throw new NotImplementedError(); };

export const VoidLabels = async (request: requests.VoidLabelsRequest): Promise<responses.VoidLabelsResponse> => {
